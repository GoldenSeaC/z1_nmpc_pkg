...
LowlevelCmd *lowcmd;//same as _ctrlComp->lowcmd 这个是即将发送的指令
LowlevelState *lowstate;//same as _ctrlComp->lowstate 这个可以获得返回的机械臂状态
CtrlComponents *_ctrlComp;//猜测 内部的通信实现依赖这个成员变量
